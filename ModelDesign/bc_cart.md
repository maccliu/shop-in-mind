...
CREATE TABLE `bc_cart` (
  ...
  `warehouse_id` tinyint(4) DEFAULT NULL COMMENT '发货仓库id',
  `delivery_plan_id` tinyint(4) DEFAULT NULL COMMENT '配送方式id',
  ...
  `referer_id` int(11) DEFAULT NULL COMMENT '本次购物的推荐人id',
...
> 3. referer_id是用于社会化营销场景的。如果本次购物是由某个推荐人推荐的，可以记录下来推荐人，用于给推荐人做推荐佣金。
